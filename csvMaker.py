...
input_data_path = 'users\\'
output_file_name = 'twitter_users_12.csv'
...
# headerFile = open('csvHeader.txt', "r")
# contents = headerFile.read()
# contents = contents.encode('utf-8', 'ignore')
output_file = open(output_file_name, "a")
# output_file.write(contents)

# these next calls are for the DECIMAL package and make it so that all decimals are rounded UP to the
